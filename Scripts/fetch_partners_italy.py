#!/usr/bin/env python3
"""Fetch partners in Italy from Salesforce using the FastMCP server via stdio."""
    ...
    def _initialize(self):
        ...
        try:
            response = self._send_jsonrpc("initialize", {
                ...
                "capabilities": {},
                "clientInfo": {
                    "name": "fetch-partners-italy-script",
                    "version": "1.0.0"
                }
            })
...
def main():
    ...
    try:
        client = MCPClient()
        print("✅ Server ready. Querying Partners in Italy...\n")
        
        query = "SELECT Id, Name, Type, BillingCity, BillingState, Phone, Website FROM Account WHERE BillingCountry = 'Italy' AND (Type LIKE '%Partner%' OR Type = 'Channel Partner / Reseller' OR Type = 'Reseller') LIMIT 20"
